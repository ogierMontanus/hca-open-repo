 ...
 *   personHref(name)         → 'person.html?reg=…' | 'persons.html'
...
window.EntityRefs = (function () {
  ...
  function personHref(name)  { var r = personRid(name);  return r ? 'person.html?reg=' + r : 'persons.html'; }
  ...
  function personHrefByRid(r){ return r ? 'person.html?reg=' + r : 'persons.html'; }
